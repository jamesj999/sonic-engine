...
public class Sonic2 extends Game {
    ...
    private static final int[][] START_POSITIONS = {
            {0x0060, 0x0400}, // 0 Emerald Hill 1
            {0x0060, 0x0400}, // 1 Emerald Hill 2
            {0x0060, 0x0400}, // 2 Unused
            {0x0060, 0x0400}, // 3 Unused
            {0x0060, 0x0400}, // 4 Chemical Plant 1
            {0x0060, 0x0400}, // 5 Chemical Plant 2
            {0x0060, 0x0400}, // 6 Aquatic Ruin 1
            {0x0060, 0x0400}, // 7 Aquatic Ruin 2
            {0x0060, 0x0400}, // 8 Casino Night 1
            {0x0060, 0x0400}, // 9 Casino Night 2
            {0x0060, 0x0400}, // 10 Hill Top 1
            {0x0060, 0x0400}, // 11 Hill Top 2
            {0x0060, 0x0400}, // 12 Mystic Cave 1
            {0x0060, 0x0400}, // 13 Mystic Cave 2
            {0x0060, 0x0400}, // 14 Oil Ocean 1
            {0x0060, 0x0400}, // 15 Oil Ocean 2
            {0x0060, 0x0400}, // 16 Metropolis 1
            {0x0060, 0x0400}, // 17 Metropolis 2
            {0x0060, 0x0400}, // 18 Metropolis 3
            {0x0060, 0x0400}, // 19 Unused
            {0x0000, 0x0000}, // 20 Sky Chase 1
