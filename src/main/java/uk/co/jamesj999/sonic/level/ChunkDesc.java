 ...
 * should be drawn. A chunk may be
...
public final class ChunkDesc {
    ...
    private boolean primarySolid; // Cached: (index & 0x3000) != 0
    private boolean secondarySolid; // Cached: (index & 0xC000) != 0
    ...
    private void updateFields() {
        ...
        // Cache solidity checks to avoid repeated bit operations
        this.primarySolid = (index & 0x3000) != 0;
        this.secondarySolid = (index & 0xC000) != 0;
    }
