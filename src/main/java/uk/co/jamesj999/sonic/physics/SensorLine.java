...
public class SensorLine {
   ...
   public short getHeight() {
      SpriteRunningMode spriteRunningMode = SpriteRunningMode.GROUND;
      if(sprite instanceof AbstractPlayableSprite) {
         spriteRunningMode = ((AbstractPlayableSprite) sprite).getRunningMode();
      }
      ...
      for (int checkX = startX; checkX <= endX; checkX++) {
         ...
         for (int checkY = startY; checkY <= endY; checkY++) {
            ...
            if (tile != null) {
               byte heightOfTile = tile.getHeightAt(offset, spriteRunningMode);
               toUse = tile;
               if (((startY == endY) && (checkX == endX))
                  ...
                  if (tileAbove != null) {
                     byte heightOfTileAbove = tileAbove
                             .getHeightAt(offset, spriteRunningMode);
