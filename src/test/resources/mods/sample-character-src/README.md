...
```powershell
./build.ps1 C:\path\OpenGGF-0.8.prerelease-jar-with-dependencies.jar C:\path\OpenGGF-0.8.prerelease-openggf-mod-sdk.jar C:\temp\phase3-character
```

POSIX shell:

```sh
./build.sh /path/OpenGGF-0.8.prerelease-jar-with-dependencies.jar /path/OpenGGF-0.8.prerelease-openggf-mod-sdk.jar /tmp/phase3-character
```
