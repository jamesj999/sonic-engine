...
/**
 * Replays special stage 1 (recorded {@code special_stage_index} 0) from the
 ...
 */
class TestS1SpecialStage1TraceReplay extends AbstractS1SpecialStageTraceReplayTest {
    @Override
