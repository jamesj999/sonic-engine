...
/** S1 GHZ1 from the complete-run TAS (bk2 offset 788, 5598 frames).
...
public class TestS1Ghz1CompleteRunTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s1/ghz1_completerun"); }
}
