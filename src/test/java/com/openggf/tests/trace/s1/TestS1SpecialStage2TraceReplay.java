...
/**
 * Replays special stage 2 (recorded {@code special_stage_index} 1) from the
 ...
 */
class TestS1SpecialStage2TraceReplay extends AbstractS1SpecialStageTraceReplayTest {
    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s1", "runs",
                "s1-sonic-complete-withemeralds", "ss_2");
    }
}
