...
/**
 * Replays special stage 6 (recorded {@code special_stage_index} 5) from the
 ...
 */
class TestS1SpecialStage6TraceReplay extends AbstractS1SpecialStageTraceReplayTest {
    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s1", "runs",
                "s1-sonic-complete-withemeralds", "ss_6");
    }
}
