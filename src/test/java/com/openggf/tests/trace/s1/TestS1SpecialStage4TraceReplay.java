...
/**
 * Replays special stage 4 (recorded {@code special_stage_index} 3) from the
 ...
 */
class TestS1SpecialStage4TraceReplay extends AbstractS1SpecialStageTraceReplayTest {
    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s1", "runs",
                "s1-sonic-complete-withemeralds", "ss_4");
    }
}
