...
/**
 * Replays special stage 3 (recorded {@code special_stage_index} 2) from the
 ...
 */
class TestS1SpecialStage3TraceReplay extends AbstractS1SpecialStageTraceReplayTest {
    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s1", "runs",
                "s1-sonic-complete-withemeralds", "ss_3");
    }
}
