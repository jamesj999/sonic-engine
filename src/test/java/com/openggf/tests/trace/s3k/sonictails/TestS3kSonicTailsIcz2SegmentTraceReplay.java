...
/**
 * Compared replay of segment {@code icz_2} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 5, act 2,
 * bk2 offset 187298, 6401 rows.
 *
...
public class TestS3kSonicTailsIcz2SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/icz_2"); }
}
