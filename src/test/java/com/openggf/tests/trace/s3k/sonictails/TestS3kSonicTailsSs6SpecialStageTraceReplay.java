...
/**
 * Compared replay of special-stage segment {@code ss_6} (special stage index
 * 5) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * bk2 offset 77284, 6343 rows.
 *
...
public class TestS3kSonicTailsSs6SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ss_6"); }
}
