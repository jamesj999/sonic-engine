...
/**
 * Compared replay of segment {@code mgz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 2, act 1, bk2 offset 87698, 2339 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainMgzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/mgz"); }
}
