 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 6, act 1,
 * bk2 offset 193700, 32740 rows.
 *
...
public class TestS3kSonicTailsLbzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/lbz"); }
}
