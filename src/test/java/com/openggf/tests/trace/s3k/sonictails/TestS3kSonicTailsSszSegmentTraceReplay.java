 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 11, act 1,
 * bk2 offset 468982, 40049 rows.
 *
...
public class TestS3kSonicTailsSszSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ssz"); }
}
