...
/**
 * Compared replay of segment {@code mhz_7} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 7, act 2,
 * bk2 offset 275484, 2169 rows.
 *
...
public class TestS3kSonicTailsMhz7SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mhz_7"); }
}
