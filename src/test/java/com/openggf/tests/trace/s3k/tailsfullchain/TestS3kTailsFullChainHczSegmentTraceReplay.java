...
/**
 * Compared replay of segment {@code hcz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 1, act 1, bk2 offset 44694, 4680 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHczSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hcz"); }
}
