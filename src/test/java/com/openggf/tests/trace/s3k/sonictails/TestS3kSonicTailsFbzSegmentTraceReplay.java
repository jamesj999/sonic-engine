 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 4, act 1,
 * bk2 offset 302654, 33834 rows.
 *
...
public class TestS3kSonicTailsFbzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/fbz"); }
}
