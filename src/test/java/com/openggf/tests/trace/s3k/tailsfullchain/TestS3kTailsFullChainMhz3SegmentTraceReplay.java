...
/**
 * Compared replay of segment {@code mhz_3} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 7, act 1, bk2 offset 256084, 5231 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainMhz3SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/mhz_3"); }
}
