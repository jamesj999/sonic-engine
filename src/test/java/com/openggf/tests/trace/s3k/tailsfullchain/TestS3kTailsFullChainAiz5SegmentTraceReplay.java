...
/**
 * Compared replay of segment {@code aiz_5} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 0, act 2, bk2 offset 36640, 8053 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainAiz5SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/aiz_5"); }
}
