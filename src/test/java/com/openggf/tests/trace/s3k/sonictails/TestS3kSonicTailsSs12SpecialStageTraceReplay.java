...
/**
 * Compared replay of special-stage segment {@code ss_12} (special stage index 4 -- NOT the directory ordinal; ROM sub_85B0 masks the
 * index with {@code andi.w #7,d0} (sonic3k.asm:10858), so it is 0-7 in BOTH
 * halves and does not uniquely identify a segment: index 4 also names
