...
/**
 * Compared replay of segment {@code soz_2} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 8, act 2, bk2 offset 355461, 15119 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSoz2SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/soz_2"); }
}
