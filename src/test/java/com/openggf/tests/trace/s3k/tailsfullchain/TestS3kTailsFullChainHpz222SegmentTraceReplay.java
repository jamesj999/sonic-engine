...
/**
 * Compared replay of segment {@code hpz22_2} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 22, act 2, bk2 offset 419298, 4604 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHpz222SegmentTraceReplay extends AbstractTraceReplayTest {
    @Override protected SonicGame game() { return SonicGame.SONIC_3K; }
    @Override protected int zone() { return 22; }
    @Override protected int act() { return 1; }
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hpz22_2"); }
}
