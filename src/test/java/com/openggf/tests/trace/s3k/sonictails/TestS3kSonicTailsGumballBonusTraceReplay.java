...
/**
 * Compared replay of bonus-stage segment {@code gumball}
 * (gumball) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * zone_id 19, bk2 offset 186559,
 * 738 rows.
 *
...
public class TestS3kSonicTailsGumballBonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/gumball"); }
}
