 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 2, act 1,
 * bk2 offset 100896, 30973 rows.
 *
...
public class TestS3kSonicTailsMgzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mgz"); }
}
