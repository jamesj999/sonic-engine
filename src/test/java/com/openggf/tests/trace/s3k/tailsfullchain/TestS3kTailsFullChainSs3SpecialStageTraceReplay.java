...
/**
 * Compared replay of special-stage segment {@code ss_3} (special stage index 2) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 21353, 4551 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs3SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_3"); }
}
