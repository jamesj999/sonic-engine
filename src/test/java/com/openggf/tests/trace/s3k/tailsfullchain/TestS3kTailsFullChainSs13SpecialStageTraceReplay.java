...
/**
 * Compared replay of special-stage segment {@code ss_13} (special stage index 5) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 292462, 4658 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs13SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_13"); }
}
