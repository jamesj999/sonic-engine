 ...
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 1, act 1, bk2 offset 52742, 1590 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHcz2SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hcz_2"); }
}
