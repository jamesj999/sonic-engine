...
/**
 * Compared replay of bonus-stage segment {@code pachinko}
 * (pachinko) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * zone_id 20, bk2 offset 431001,
 * 3067 rows.
 *
...
public class TestS3kSonicTailsPachinkoBonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/pachinko"); }
}
