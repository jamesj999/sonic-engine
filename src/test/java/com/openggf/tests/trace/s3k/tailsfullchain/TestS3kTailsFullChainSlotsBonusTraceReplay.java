...
/**
 * Compared replay of bonus-stage segment {@code slots} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 21, bk2 offset 62132, 1168 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSlotsBonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/slots"); }
}
