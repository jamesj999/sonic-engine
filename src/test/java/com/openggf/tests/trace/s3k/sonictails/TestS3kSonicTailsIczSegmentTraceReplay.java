 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 5, act 1,
 * bk2 offset 168515, 18043 rows.
 *
...
public class TestS3kSonicTailsIczSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/icz"); }
}
