...
/**
 * Compared replay of special-stage segment {@code ss_15} (special stage index 0) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 348098, 5735 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs15SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_15"); }
}
