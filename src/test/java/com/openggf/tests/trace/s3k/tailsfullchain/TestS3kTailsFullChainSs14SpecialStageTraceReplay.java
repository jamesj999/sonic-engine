...
/**
 * Compared replay of special-stage segment {@code ss_14} (special stage index 3) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 313104, 3527 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs14SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_14"); }
}
