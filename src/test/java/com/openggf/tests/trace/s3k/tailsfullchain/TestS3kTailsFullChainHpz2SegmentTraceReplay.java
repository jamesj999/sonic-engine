...
/**
 * Compared replay of segment {@code hpz_2} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 10, act 1, bk2 offset 433476, 10582 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHpz2SegmentTraceReplay extends AbstractTraceReplayTest {
    @Override protected SonicGame game() { return SonicGame.SONIC_3K; }
    @Override protected int zone() { return 10; }
    @Override protected int act() { return 0; }
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hpz_2"); }
}
