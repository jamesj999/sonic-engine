...
/**
 * Compared replay of special-stage segment {@code ss_2} (special stage index
 * 1) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * bk2 offset 12841, 5435 rows.
 *
...
public class TestS3kSonicTailsSs2SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ss_2"); }
}
