...
/**
 * Compared replay of special-stage segment {@code ss} (special stage index 0) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 2126, 3373 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSsSpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss"); }
}
