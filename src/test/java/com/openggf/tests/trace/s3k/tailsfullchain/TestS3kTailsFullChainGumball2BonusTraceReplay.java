...
/**
 * Compared replay of bonus-stage segment {@code gumball_2} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 19, bk2 offset 375128, 2509 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainGumball2BonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/gumball_2"); }
}
