 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 13, act 2,
 * bk2 offset 524341, 14825 rows.
 *
...
public class TestS3kSonicTailsDdzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ddz"); }
}
