...
/**
 * Compared replay of segment {@code ssz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 11, act 1, bk2 offset 444059, 23249 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSszSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ssz"); }
}
