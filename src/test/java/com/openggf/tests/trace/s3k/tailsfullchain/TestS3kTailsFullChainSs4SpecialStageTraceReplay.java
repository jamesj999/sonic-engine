...
/**
 * Compared replay of special-stage segment {@code ss_4} (special stage index 3) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 32367, 3523 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs4SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_4"); }
}
