...
/**
 * Compared replay of segment {@code mhz_9} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 7, act 2,
 * bk2 offset 295461, 7192 rows.
 *
...
public class TestS3kSonicTailsMhz9SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mhz_9"); }
}
