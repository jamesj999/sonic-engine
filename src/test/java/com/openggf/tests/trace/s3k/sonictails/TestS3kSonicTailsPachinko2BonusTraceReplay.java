...
/**
 * Compared replay of bonus-stage segment {@code pachinko_2}
 * (pachinko) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * zone_id 20, bk2 offset 456559,
 * 3774 rows.
 *
...
public class TestS3kSonicTailsPachinko2BonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/pachinko_2"); }
}
