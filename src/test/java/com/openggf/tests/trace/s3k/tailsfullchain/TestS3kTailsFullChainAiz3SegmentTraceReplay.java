...
/**
 * Compared replay of segment {@code aiz_3} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 0, act 2, bk2 offset 15097, 6255 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainAiz3SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/aiz_3"); }
}
