...
/**
 * Compared replay of segment {@code dez23_6} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 23, act 2, bk2 offset 312827, 276 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainDez236SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/dez23_6"); }
}
