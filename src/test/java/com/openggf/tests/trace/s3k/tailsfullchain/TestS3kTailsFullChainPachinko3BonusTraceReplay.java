...
/**
 * Compared replay of bonus-stage segment {@code pachinko_3} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 20, bk2 offset 429927, 3548 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainPachinko3BonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/pachinko_3"); }
}
