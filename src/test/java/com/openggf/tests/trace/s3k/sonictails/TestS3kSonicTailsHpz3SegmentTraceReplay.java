...
/**
 * Compared replay of segment {@code hpz_3} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 10, act 1,
 * bk2 offset 465044, 3937 rows.
 *
...
public class TestS3kSonicTailsHpz3SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/hpz_3"); }
}
