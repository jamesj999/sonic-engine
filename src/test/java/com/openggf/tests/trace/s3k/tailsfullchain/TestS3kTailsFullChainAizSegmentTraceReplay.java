...
/**
 * Compared replay of segment {@code aiz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 0, act 1, bk2 offset 758, 1367 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainAizSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/aiz"); }
}
