...
/**
 * Compared replay of special-stage segment {@code ss_6} (special stage index 5) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 68435, 4741 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs6SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_6"); }
}
