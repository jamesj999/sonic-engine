...
/**
 * Compared replay of special-stage segment {@code ss_11} (special stage index 4) of the committed {@code s3k-tails-full-chain-all-emeralds} run --
 * bk2 offset 261537, 3475 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSs11SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ss_11"); }
}
