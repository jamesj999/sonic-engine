...
/**
 * Compared replay of segment {@code soz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 8, act 1, bk2 offset 326320, 21412 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSozSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/soz"); }
}
