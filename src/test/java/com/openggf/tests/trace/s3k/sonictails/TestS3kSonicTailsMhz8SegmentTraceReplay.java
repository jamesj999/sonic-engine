...
/**
 * Compared replay of segment {@code mhz_8} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 7, act 2,
 * bk2 offset 284610, 1992 rows.
 *
...
public class TestS3kSonicTailsMhz8SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mhz_8"); }
}
