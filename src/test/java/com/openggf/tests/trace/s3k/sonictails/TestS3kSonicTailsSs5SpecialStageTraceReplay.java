...
/**
 * Compared replay of special-stage segment {@code ss_5} (special stage index
 * 4) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * bk2 offset 57183, 4421 rows.
 *
...
public class TestS3kSonicTailsSs5SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ss_5"); }
}
