 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 3, act 1,
 * bk2 offset 131870, 36644 rows.
 *
...
public class TestS3kSonicTailsCnzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/cnz"); }
}
