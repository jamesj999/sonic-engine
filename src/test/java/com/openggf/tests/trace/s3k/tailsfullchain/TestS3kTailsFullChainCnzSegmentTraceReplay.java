...
/**
 * Compared replay of segment {@code cnz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 3, act 1, bk2 offset 134171, 40223 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainCnzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/cnz"); }
}
