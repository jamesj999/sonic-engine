...
/**
 * Compared replay of segment {@code zone0c} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 12, act 1,
 * bk2 offset 514214, 10126 rows.
 *
...
public class TestS3kSonicTailsZone0cSegmentTraceReplay extends AbstractTraceReplayTest {
    @Override protected SonicGame game() { return SonicGame.SONIC_3K; }
    @Override protected int zone() { return 12; }
    @Override protected int act() { return 0; }
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/zone0c"); }
}
