...
/**
 * Compared replay of special-stage segment {@code ss_9} (special stage index 1 -- NOT the directory ordinal; ROM sub_85B0 masks the
 * index with {@code andi.w #7,d0} (sonic3k.asm:10858), so it is 0-7 in BOTH
 * halves and does not uniquely identify a segment: index 1 also names
...
public class TestS3kSonicTailsSs9SpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ss_9"); }
}
