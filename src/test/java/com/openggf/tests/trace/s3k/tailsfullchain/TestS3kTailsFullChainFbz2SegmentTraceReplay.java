...
/**
 * Compared replay of segment {@code fbz_2} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 4, act 1, bk2 offset 298344, 14482 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainFbz2SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/fbz_2"); }
}
