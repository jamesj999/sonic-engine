...
/**
 * Compared replay of segment {@code lbz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 6, act 1, bk2 offset 196877, 42307 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainLbzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/lbz"); }
}
