...
/**
 * Compared replay of segment {@code lrz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 9, act 1, bk2 offset 370581, 4546 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainLrzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/lrz"); }
}
