 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 0, act 2,
 * bk2 offset 46432, 7175 rows.
 *
...
public class TestS3kSonicTailsAiz5SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/aiz_5"); }
}
