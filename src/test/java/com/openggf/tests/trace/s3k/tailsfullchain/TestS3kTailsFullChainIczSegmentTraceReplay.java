...
/**
 * Compared replay of segment {@code icz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 5, act 1, bk2 offset 174395, 22481 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainIczSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/icz"); }
}
