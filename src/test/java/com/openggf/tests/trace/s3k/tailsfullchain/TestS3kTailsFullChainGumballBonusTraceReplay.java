...
/**
 * Compared replay of bonus-stage segment {@code gumball} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 19, bk2 offset 54333, 969 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainGumballBonusTraceReplay extends AbstractS3kBonusStageTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/gumball"); }
}
