...
/**
 * Compared replay of segment {@code ddz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 13, act 2, bk2 offset 484147, 15531 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainDdzSegmentTraceReplay extends AbstractTraceReplayTest {
    @Override protected SonicGame game() { return SonicGame.SONIC_3K; }
    @Override protected int zone() { return 13; }
    @Override protected int act() { return 1; }
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ddz"); }
}
