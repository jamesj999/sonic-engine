 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 9, act 1,
 * bk2 offset 389982, 38885 rows.
 *
...
public class TestS3kSonicTailsLrzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/lrz"); }
}
