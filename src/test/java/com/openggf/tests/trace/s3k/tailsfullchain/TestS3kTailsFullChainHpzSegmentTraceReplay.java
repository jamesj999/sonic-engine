...
/**
 * Compared replay of segment {@code hpz} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 10, act 1, bk2 offset 423903, 6023 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHpzSegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hpz"); }
}
