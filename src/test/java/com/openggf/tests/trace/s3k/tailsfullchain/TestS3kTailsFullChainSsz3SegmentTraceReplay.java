...
/**
 * Compared replay of segment {@code ssz_3} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 11, act 2, bk2 offset 474718, 3877 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainSsz3SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/ssz_3"); }
}
