...
/**
 * Compared replay of segment {@code hpz22} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 22, act 1, bk2 offset 404925, 12956 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHpz22SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hpz22"); }
}
