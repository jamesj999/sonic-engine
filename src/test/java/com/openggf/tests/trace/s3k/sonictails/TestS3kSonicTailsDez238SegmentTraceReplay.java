 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 23, act 1,
 * bk2 offset 509032, 5181 rows.
 *
...
public class TestS3kSonicTailsDez238SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/dez23_8"); }
}
