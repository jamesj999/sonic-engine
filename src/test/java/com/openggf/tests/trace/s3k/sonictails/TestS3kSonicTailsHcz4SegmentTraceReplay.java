 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 1, act 2,
 * bk2 offset 97208, 3687 rows.
 *
...
public class TestS3kSonicTailsHcz4SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/hcz_4"); }
}
