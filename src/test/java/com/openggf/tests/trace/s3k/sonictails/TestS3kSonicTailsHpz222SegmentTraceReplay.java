 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 22, act 1,
 * bk2 offset 434069, 14850 rows.
 *
...
public class TestS3kSonicTailsHpz222SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/hpz22_2"); }
}
