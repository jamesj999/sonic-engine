...
/**
 * Compared replay of segment {@code hcz_6} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 1, act 2, bk2 offset 82532, 5165 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainHcz6SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/hcz_6"); }
}
