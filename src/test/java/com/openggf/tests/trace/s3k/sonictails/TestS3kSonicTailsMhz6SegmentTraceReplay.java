...
/**
 * Compared replay of segment {@code mhz_6} of the committed
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 7, act 1,
 * bk2 offset 263465, 4516 rows.
 *
...
public class TestS3kSonicTailsMhz6SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mhz_6"); }
}
