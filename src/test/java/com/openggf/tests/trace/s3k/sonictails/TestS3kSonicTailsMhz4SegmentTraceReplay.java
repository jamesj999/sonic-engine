 ...
 * {@code s3k-sonic-tails-complete-emeralds} run -- zone_id 7, act 1,
 * bk2 offset 253502, 1083 rows.
 *
...
public class TestS3kSonicTailsMhz4SegmentTraceReplay extends AbstractTraceReplayTest {
    ...
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/mhz_4"); }
}
