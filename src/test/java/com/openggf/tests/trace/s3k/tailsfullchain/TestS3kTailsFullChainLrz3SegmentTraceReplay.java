...
/**
 * Compared replay of segment {@code lrz_3} of the committed
 * {@code s3k-tails-full-chain-all-emeralds} run -- zone_id 9, act 1, bk2 offset 389691, 15233 rows.
 *
...
@Tag("trace-scope-r7")
public class TestS3kTailsFullChainLrz3SegmentTraceReplay extends AbstractTraceReplayTest {
    @Override protected SonicGame game() { return SonicGame.SONIC_3K; }
    @Override protected int zone() { return 9; }
    @Override protected int act() { return 0; }
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-tails-full-chain-all-emeralds/lrz_3"); }
}
