...
/**
 * Compared replay of special-stage segment {@code ss} (special stage index
 * 0) of the committed {@code s3k-sonic-tails-complete-emeralds} run --
 * bk2 offset 2868, 4469 rows.
 *
...
public class TestS3kSonicTailsSsSpecialStageTraceReplay extends AbstractS3kSpecialStageTraceReplayTest {
    @Override protected Path traceDirectory() { return Path.of("src/test/resources/traces/s3k/runs/s3k-sonic-tails-complete-emeralds/ss"); }
}
