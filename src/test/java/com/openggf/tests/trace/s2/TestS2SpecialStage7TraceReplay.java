...
/**
 * S2 special-stage trace replay against segment {@code ss_7} of the committed
 * {@code s2-sonic-tails-complete-emeralds} run — the run's special stage
 * 7 (recorder {@code special_stage_index} 6, Sonic + Tails).
 *
 ...
 */
class TestS2SpecialStage7TraceReplay extends AbstractS2SpecialStageTraceReplayTest {

    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s2", "runs",
                "s2-sonic-tails-complete-emeralds", "ss_7");
    }
}
