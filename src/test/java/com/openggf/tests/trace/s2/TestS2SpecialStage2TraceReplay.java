...
/**
 * S2 special-stage trace replay against segment {@code ss_2} of the committed
 * {@code s2-sonic-tails-complete-emeralds} run — the run's special stage
 * 2 (recorder {@code special_stage_index} 1, Sonic + Tails).
 *
 ...
 */
class TestS2SpecialStage2TraceReplay extends AbstractS2SpecialStageTraceReplayTest {

    @Override
    protected Path traceDirectory() {
        return Path.of("src", "test", "resources", "traces", "s2", "runs",
                "s2-sonic-tails-complete-emeralds", "ss_2");
    }
}
