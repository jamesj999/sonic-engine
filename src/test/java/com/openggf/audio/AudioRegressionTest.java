 ...
 *
 * Reference files are generated by AudioReferenceGenerator and stored beneath the explicit external fixture root in audio-reference/
 */
public class AudioRegressionTest {
    ...
    @Test
    @org.junit.jupiter.api.Tag("audio-local-wave")
    public void testMusicEhzMatchesReference() throws Exception {
        assertNotNull(loader, "Local WAV comparison requires the Sonic 2 ROM");
        com.openggf.tests.AudioReferenceFixtures.require(REFERENCE_DIR);
    ...
    public void testMixedMusicSfxMatchesReference() throws Exception {
        assertNotNull(loader, "Local WAV comparison requires the Sonic 2 ROM");
        com.openggf.tests.AudioReferenceFixtures.require(REFERENCE_DIR);
        assertTrue(referenceFileExists("mixed_music_sfx.wav"), "Mixed reference file not found");
    ...
    private void assertMusicMatchesReference(String filename, int musicId, double durationSeconds) throws Exception {
        assertTrue(referenceFileExists(filename), "Reference file not found: " + filename);
    ...
    private static boolean referenceFileExists(String filename) {
        return Files.isRegularFile(com.openggf.tests.AudioReferenceFixtures.require(
                REFERENCE_DIR + "/" + filename));
    }

    private short[] loadReferenceWav(String filename) throws IOException, UnsupportedAudioFileException {
        return loadWavFromFile(com.openggf.tests.AudioReferenceFixtures.require(
                REFERENCE_DIR + "/" + filename).toFile());
    }
