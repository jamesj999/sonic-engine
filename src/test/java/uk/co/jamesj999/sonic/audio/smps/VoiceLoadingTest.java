...
public class VoiceLoadingTest {
    ...
    public void testVoiceLoadingSonic1() {
        ...
        // Actually for channels=2:
        // i=0: offset 6. DAC.
        // i=1: offset 10 (0x0A). FM1.
    ...
    public void testVoiceLoadingSonic2() {
        ...
        // TL
        voiceData[21] = 0x61; voiceData[22] = 0x62; voiceData[23] = 0x63; voiceData[24] = 0x64;
        ...
        // TL (60) -> Moved from 21. Swap: 61, 63, 62, 64
        expected[5] = 0x61; expected[6] = 0x63; expected[7] = 0x62; expected[8] = 0x64;

        // RS (20) -> Moved from 5. Swap: 21, 23, 22, 24
        ...
        // RR (50) -> Moved from 17. Swap: 51, 53, 52, 54
